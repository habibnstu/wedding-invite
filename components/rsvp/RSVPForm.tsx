...
export default function RSVPForm({
  ...
  return (
    <section
      id="rsvp"
      className="w-full overflow-hidden px-1 py-1 sm:px-1 md:px-1"
    >
     <div className="text-center">
        ...
        <p className="mt-1 px-2 text-sm text-[#7a6a58] md:text-base">
      ...
      <div className="gold-divider mt-1 mb-10 sm:mb-2" />

      <div className="mx-auto w-full max-w-lg glass rounded-3xl p-2 sm:p-2 md:p-4">
        {status === "success" ? (
          <div className="py-8 text-center sm:py-4">
...
>
      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-3">
        {(
          ...
          <button
            ...
            className={`min-h-[40px] w-full rounded-xl border-2 px-2 py-2 text-sm font-medium transition-all duration-300 sm:min-h-0 ${
          ...
          >
            <div className="mb-1 text-xl sm:text-2xl">
              {option.icon}
            </div>
  ...
  <div className="grid grid-cols-[110px_1fr] items-center gap-3">
    ...
    <input
      ...
      className="block w-full min-w-0 rounded-xl border px-4 py-3 text-base outline-none"
    />
  </div>
  ...
  <div className="grid grid-cols-[110px_1fr] items-start gap-3">
    ...
    <textarea
      ...
      suppressHydrationWarning
      {...register("message")}
      className="block w-full min-w-0 resize-y rounded-xl border px-4 py-3 text-base outline-none"
    />
  </div>
